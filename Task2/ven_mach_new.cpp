...
int main(){
    ...
    while(n<1){
        ...
        switch(choice){
        case 1:
            credit=product_purchase(credit, 0);
            break;
        case 2:
            credit=product_purchase(credit, 1);
            break;
        case 3:
            credit=product_purchase(credit, 2);
            break;
        case 4:
            credit=product_purchase(credit, 3);
            break;
        case 5:
            credit=product_purchase(credit, 4);
            break;
        case 6:
